...
export default class SetApi {
  ...
  createSetWithHttpInfo(documentSet) {
    ...
    if (documentSet === undefined || documentSet === null) {
      throw new Error(
        "Missing the required parameter 'documentSet' when calling createSet"
      );
    }
  ...
  createSet(documentSet) {
    return this.createSetWithHttpInfo(documentSet).then(function(
      response_and_data
    ) {
  ...
  deleteSetWithHttpInfo(setId) {
    ...
    if (setId === undefined || setId === null) {
      throw new Error(
        "Missing the required parameter 'setId' when calling deleteSet"
      );
    }
  ...
  getSetWithHttpInfo(setId) {
    ...
    if (setId === undefined || setId === null) {
      throw new Error(
        "Missing the required parameter 'setId' when calling getSet"
      );
    }
