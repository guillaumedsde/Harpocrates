...
class Document {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('textSplitGranularity')) {
                obj['textSplitGranularity'] = ApiClient.convertToType(data['textSplitGranularity'], 'String');
            }
...
/**
 * Granularity of the split of the document's content
 * @member {module:model/Document.TextSplitGranularityEnum} textSplitGranularity
 */
Document.prototype['textSplitGranularity'] = undefined;
...
/**
 * Allowed values for the <code>textSplitGranularity</code> property.
 * @enum {String}
 * @readonly
 */
Document['TextSplitGranularityEnum'] = {
