  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty("sensitive")) {
        obj["sensitive"] = ApiClient.convertToType(
          data["sensitive"],
          "Boolean"
        );
      }
      if (data.hasOwnProperty("sensitivity")) {
        obj["sensitivity"] = ApiClient.convertToType(
          data["sensitivity"],
          "Number"
        );
      }
      if (data.hasOwnProperty("classifier")) {
        obj["classifier"] = ApiClient.convertToType(
          data["classifier"],
          "String"
        );
      }
      if (data.hasOwnProperty("explanations")) {
        obj["explanations"] = ApiClient.convertToType(data["explanations"], [
