...
- API version: 10.0.0-multiplefileupload.0
- Package version: 10.0.0-multiplefileupload.0
...
api.createDocument(setId, opts).then(function(data) {
...
## Documentation for Models
 ...
 - [@HarpocratesApiClient.InlineObject](docs/InlineObject.md)
