...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @HarpocratesApiClient.PredictedClassificationExplanation();
  });
  ...
  describe('PredictedClassificationExplanation', function() {
    it('should create an instance of PredictedClassificationExplanation', function() {
      ...
      //var instane = new @HarpocratesApiClient.PredictedClassificationExplanation();
      //expect(instance).to.be.a(@HarpocratesApiClient.PredictedClassificationExplanation);
    });
