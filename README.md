...
*@HarpocratesApiClient.DocumentApi* | [**getPredictedClassificationExplanation**](docs/DocumentApi.md#getPredictedClassificationExplanation) | **GET** /documentSet/{setId}/{docId}/predictedClassificationExplanation | Get the explanation for the predicted classification of a document
