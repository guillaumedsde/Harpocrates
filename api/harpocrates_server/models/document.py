...
class Document(Model):
    ...
    def __init__(self, name=None, document_id=None, predicted_classification=None, paragraphs=None):  # noqa: E501
    ...
    def paragraphs(self, paragraphs):
        ...
        if paragraphs is None:
            raise ValueError("Invalid value for `paragraphs`, must not be `None`")  # noqa: E501
