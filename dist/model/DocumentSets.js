...
var _DocumentSet = _interopRequireDefault(require("./DocumentSet"));
...
function () {
   ...
   */
  function DocumentSets(documentSets) {
    _classCallCheck(this, DocumentSets);
  ...
  _createClass(DocumentSets, null, [{
    key: "initialize",
    value: function initialize(obj, documentSets) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('documentSets')) {
          obj['documentSets'] = _ApiClient["default"].convertToType(data['documentSets'], [_DocumentSet["default"]]);
        }
      }
